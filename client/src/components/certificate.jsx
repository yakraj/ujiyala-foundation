      ...
      <div className="calibre" ref={certificateRef} id="calibre_link-0">
        <div className="Logo-and-name">
          ...
          <div>
            ...
            <p
              style={{ color: "#ff520d", fontSize: "0.8rem" }}
              className="block_1"
            >
        ...
        <p className="block_6">
          has officially become a Permanent Member of the{" "}
          <span className="ujiyala-font">Ujiyala Foundation</span>, effective
          from {joinDate}, under Membership No. {membershipNo}.
        </p>
        <p className="block_6">
          As a member, <b className="calibre3">{memberName}</b> pledges to
          uphold the Foundation's vision of empowering lives, serving
          communities, and spreading hope. This membership remains valid until{" "}
          {expiryDate}.
        </p>
